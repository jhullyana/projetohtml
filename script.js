...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Obtém o botão "Leia mais" e o conteúdo completo da notícia
    var readMoreButton = document.querySelector('.read-more-btn');
    var fullContent = document.querySelector('.full-content');

    // Define um evento de clique para o botão
    readMoreButton.addEventListener('click', function() {
        // Alterna a classe 'visible' no conteúdo completo para mostrar ou ocultar
        fullContent.classList.toggle('visible');

        // Altera o texto do botão com base na visibilidade do conteúdo
        var fullContent = document.querySelector('.full-content');
        readMoreButton.addEventListener('click', function() {
            fullContent.classList.toggle('visible');
        
            console.log(fullContent.classList.contains('visible'));
